...
class Model_Finder:
    ...
    def __init__(self, file_object, logger_object):
        ...
        self.xgb = XGBRegressor(objective='binary:logistic', n_jobs=-1)
    ...
    def get_best_params_for_rf(self, train_x, train_y):
        ...
        try:
            ...
            self.rf = RandomForestRegressor(var_smoothing=self.var_smoothing)
            ...
            self.logger_object.log(self.file_object,'Random Forest Parameter tuning  failed. Exited the get_best_params_for_naive_bayes method of the Model_Finder class')
            raise Exception()
    ...
    def get_best_params_for_xgboost(self, train_x, train_y):
        ...
        try:
            ...
            # Creating an object of the Grid Search class
            self.grid = GridSearchCV(XGBRegressor(objective='binary:logistic'), self.param_grid_xgboost, verbose=3, cv=5)
            # finding the best parameters
            self.grid.fit(train_x, train_y)
            ...
            # creating a new model with the best parameters
            self.xgb = XGBRegressor(criterion=self.criterion, max_depth=self.max_depth, n_estimators= self.n_estimators, n_jobs=-1 )
            # training the mew model
    ...
    def get_best_model(self,train_x,train_y,test_x,test_y):
        ...
        try:
            ...
            self.prediction_rf = self.random_forest.predict(test_x) # prediction using the Random Forest Algorithm
